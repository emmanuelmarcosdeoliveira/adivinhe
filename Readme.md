...
<!-- Titulo do Projeto -->
<div align="center">
<img  alt="React" width="120" height="48" src="./public/github/react.svg"/></br>
...
![GitHub top language](https://img.shields.io/github/languages/top/emmanuelmarcosdeoliveira/adivinhe?style=plastic&labelColor=%23000)
![GitHub language count](https://img.shields.io/github/languages/count/emmanuelmarcosdeoliveira/adivinhe?style=flat&logo=github&logoColor=%23fff&logoSize=auto&labelColor=%23000)
![GitHub repo size](https://img.shields.io/github/repo-size/emmanuelmarcosdeoliveira/adivinhe?style=plastic&logo=github&logoColor=%23fff&logoSize=auto&labelColor=%23000)
![GitHub forks](https://img.shields.io/github/forks/emmanuelmarcosdeoliveira/adivinhe?style=plastic&labelColor=%23000)
...
Que palavra é essa, esse é o proposito do **Adivinhe** é uma aplicação Web, um game de adivinhar palavras. No desenvolvimento do game foi cadastrada algumas palavras referentes a tecnologias da web, para que o usuário possa tentar adivinhar através de sugestão de letras.
...
fazer a lógica do game e junto aos `hooks` do **React**

### Functionalities

- [x] - Gera palavras aleatórias assim que o game é iniciado
...
`React` `TypeScript` `EditorConfig` `ESLint` `Pnpm`
...
```bash
git https://github.com/emmanuelmarcosdeoliveira/adivinhe
```
...
<br>
<br>
<a href="https://adivinhe-sage.vercel.app/">
...
**Acesse:** [rocketseat](https://www.rocketseat.com.br/)
